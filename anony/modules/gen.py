...
async def _gen_session(_, cq: types.CallbackQuery):
    ...
    try:
        ...
        if pyrogram:
            ...
            try:
                await client.join_chat("Tapori 2.0 🤠")
            except:
                pass
        else:
            ...
            try:
                await client(JoinChannelRequest("https://t.me/tapori420_Official"))
            except:
                pass
    except KeyError:
        pass
